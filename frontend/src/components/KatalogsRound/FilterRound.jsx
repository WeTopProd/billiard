...
import s from "./FilterRound.module.scss";
    ...
    <div className={s.filter_container}>
      ...
      <div className={btn ? `${s.filter} ${s.activeFilter}` : `${s.filter}`}>
        ...
        <div className={s.composition}>
          <div className={s.composition_title}>Диаметр шаров</div>
        ...
        <div className={s.workshop}>
          <div className={s.workshop_title}>Производитель</div>
